...
O presente projeto consiste no desenvolvimento de um sistema de gestão financeira pessoal denominado **FinançasPro**, implementado em **Python**.

O objetivo principal é permitir ao utilizador registar, consultar e gerir as suas receitas e despesas, bem como acompanhar o saldo disponível e planear os seus gastos.
...
- `periodo` → intervalo temporal do orçamento

**Função:**  
Permitir ao utilizador definir limites de gastos e acompanhar o controlo financeiro de forma mais organizada.

---

### 💳 Entidade Pagamento

A entidade **Pagamento** representa um pagamento efetuado pelo utilizador no sistema, associado a uma despesa ou obrigação financeira.
...
**Função:**  
Registar pagamentos realizados, facilitando o acompanhamento das saídas de dinheiro e a organização financeira.
...
- **Read (Ler)** → consulta de dados como extrato, saldo, conta, pagamentos e orçamentos
- **Update (Atualizar)** → edição de transações, pagamentos e orçamentos
- **Delete (Eliminar)** → remoção de transações, pagamentos e orçamentos
...
1. O utilizador cria uma conta ou faz login  
2. Após autenticação, acede ao menu principal  
3. Pode registar receitas e despesas  
4. Pode criar e consultar orçamentos  
5. Pode registar pagamentos  
6. Pode consultar o extrato e saldo  
7. Pode editar ou apagar informações registadas  

---

## 🧠 Conclusão

O sistema **FinançasPro** demonstra uma implementação sólida de conceitos fundamentais de programação, incluindo estruturas de dados, modularização e operações CRUD.

A utilização de códigos de erro inspirados em HTTP contribui para uma abordagem mais profissional e organizada, aproximando o funcionamento do sistema a aplicações reais.
